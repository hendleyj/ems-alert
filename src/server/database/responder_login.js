require('mongoose').model('Responder_Login');
var mongoose = require('mongoose');
var Responder_Login = mongoose.model('Responder_Login');
...
module.exports = {
    register: function (req, res) {
        ...
        Responder_Login.findOne({ 'username': req.body.username }, function (error, user) {
            if (error) {
                console.log(error);
            }
            else if (user != null) {
